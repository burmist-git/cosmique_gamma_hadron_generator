...
Int_t plots_cghg_vs_simtel_full(){
  ...
  //
  //
  fileN01 = "./hist120km_486520750ev.root";
  ...
  leg2->AddEntry(h1_01_x, "Cosmique gamma hadron generator", "apl");
  leg2->AddEntry(h1_02_x, "Simtel (with at least one p.e.)", "apl");
  //
  TLegend *leg3 = new TLegend(0.6,0.6,0.9,0.9,"","brNDC");
  leg3->AddEntry(h1_01_x, "Cosmique gamma hadron generator", "apl");
  leg3->AddEntry(h1_02_x, "Simtel (with at least one p.e.)", "apl");
  //
  TLegend *leg4 = new TLegend(0.6,0.6,0.9,0.9,"","brNDC");
  leg4->AddEntry(h1_01_x, "Cosmique gamma hadron generator", "apl");
  leg4->AddEntry(h1_02_x, "Simtel (with at least one p.e.)", "apl");
  //
